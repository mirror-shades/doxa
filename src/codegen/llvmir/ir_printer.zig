...
pub const IRPrinter = struct {
    ...
    const Self = @This();
    const RootHIR = HIR;
    const RootHIRValue = HIRValue;
    const RootHIRInstruction = HIRInstruction;
    const RootCompareInstruction = CompareInstruction;
    const RootPeekEmitState = PeekEmitState;
    const RootPeekStringInfo = PeekStringInfo;
    const RootStackType = StackType;
    const RootStackVal = StackVal;
    const RootVariableInfo = VariableInfo;
    const RootStackIncoming = StackIncoming;
    const RootStackSlot = StackSlot;
    const RootStackMergeState = StackMergeState;
    const RootEnumVariantMeta = EnumVariantMeta;
    const RootEscapeLLVMString = escapeLLVMString;
    const RootInternPeekString = internPeekString;

    const Ctx = struct {
        pub const IRPrinter = Self;
        pub const HIR = RootHIR;
        pub const HIRValue = RootHIRValue;
        pub const HIRInstruction = RootHIRInstruction;
        pub const CompareInstruction = RootCompareInstruction;
        pub const PeekEmitState = RootPeekEmitState;
        pub const PeekStringInfo = RootPeekStringInfo;
        pub const StackType = RootStackType;
        pub const StackVal = RootStackVal;
        pub const VariableInfo = RootVariableInfo;
        pub const StackIncoming = RootStackIncoming;
        pub const StackSlot = RootStackSlot;
        pub const StackMergeState = RootStackMergeState;
        pub const EnumVariantMeta = RootEnumVariantMeta;
        pub const escapeLLVMString = RootEscapeLLVMString;
        pub const internPeekString = RootInternPeekString;
    };
