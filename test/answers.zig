...
pub const expected_bigfile_results = [_]peek_result{
    ...
    .{ .type = ">int | nothing", .value = "42" },
    .{ .type = "int | >nothing", .value = "nothing" },
    .{ .type = ">int | string", .value = "30" },
    .{ .type = "int | >string", .value = "\"non_negative_only\"" },
    .{ .type = "string", .value = "\"int_arm\"" },
    .{ .type = "string", .value = "\"float_arm\"" },
    .{ .type = "float", .value = "1.0" },
    .{ .type = "byte", .value = "0xAB" },
    .{ .type = "byte", .value = "0x00" },
    .{ .type = "byte", .value = "0x01" },
    .{ .type = ">int | nothing", .value = "3" },
    .{ .type = "int | >nothing", .value = "nothing" },
    .{ .type = "int", .value = "26" },
    .{ .type = "int", .value = "4" },
    .{ .type = "string", .value = "\"M\"" },
    ...
    .{ .type = "Animal", .value = "{ name: \"Larry\", animal_type: .FROG }" },
    .{ .type = "string", .value = "\"Larry\"" },
    .{ .type = "int", .value = "3" },
    .{ .type = "int", .value = "779" },
    .{ .type = "int", .value = "782" },
    ...
    .{ .type = ">string | nothing", .value = "\"one\"" },
    .{ .type = ">string | nothing", .value = "\"two\"" },
    .{ .type = ">string | nothing", .value = "\"one\"" },
    .{ .type = ">string | nothing", .value = "\"two\"" },
    .{ .type = ">string | nothing", .value = "\"one\"" },
    .{ .type = ">string | nothing", .value = "\"two\"" },
    .{ .type = ">string | nothing", .value = "\"red\"" },
